...
import pl.bms.carspotters.CarSpottersFrontApp;
import pl.bms.carspotters.domain.Authority;
import pl.bms.carspotters.domain.User;
import pl.bms.carspotters.repository.AuthorityRepository;
...
@SpringBootTest(classes = CarSpottersFrontApp.class)
